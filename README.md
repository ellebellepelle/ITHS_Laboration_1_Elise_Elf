...
* Hade jag fått använda ArrayList hade jag inte behövt hålla reda på antalet platser i arrayerna och där med inte 
  behövt göra dem större och kopiera över dess värden osv. Men pga att jag skulle använda vanliga arrayer så får jag
  in mer träning kring att använda dess index samt att hantera när de blir fulla. 
